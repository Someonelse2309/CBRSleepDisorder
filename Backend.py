...
with tab4:
    ...
    genderW = st.number_input(label='Gender Weight', value=config['Gender'], min_value=1, max_value=10, step=1)
    ageW = st.number_input(label='Age Weight', value=config['Age'], min_value=1, max_value=10, step=1)
    occupationW = st.number_input(label='Occupation Weight', value=config['Occupation'], min_value=1, max_value=10, step=1)
    sleepDurationW = st.number_input(label='Sleep Duration Weight', value=config['Sleep Duration'], min_value=1, max_value=10, step=1)
    qualityOfSleepW = st.number_input(label='Quality of Sleep Weight', value=config['Quality of Sleep'], min_value=1, max_value=10, step=1)
    physicalActivityLevelW = st.number_input(label='Physical Activity Level', value=config['Physical Activity Level'], min_value=1, max_value=10, step=1)
    stressLevelW = st.number_input(label='Stress Level', value=config['Stress Level'], min_value=1, max_value=10, step=1)
    BMICategoryW = st.number_input(label='BMI Category', value=config['BMI Category'], min_value=1, max_value=10, step=1)
    sistoleW = st.number_input(label='Sistole', value=config['Sistole'], min_value=1, max_value=10, step=1)
    diastoleW = st.number_input(label='Diastole', value=config['Diastole'], min_value=1, max_value=10, step=1)
    heartRateW = st.number_input(label='Heart Rate', value=config['Heart Rate'], min_value=1, max_value=10, step=1)
    dailyStepsW = st.number_input(label='Daily Steps', value=config['Daily Steps'], min_value=1, max_value=10, step=1)
